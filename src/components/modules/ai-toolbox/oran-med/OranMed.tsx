  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-2xl border border-border/40 bg-card/40 p-6 backdrop-blur-sm py-[19px]">
        ...
        <div className="mt-6 rounded-xl border-border/20 px-5 backdrop-blur-md my-0 py-[6px] border-2 bg-[#f2f2f2]/[0.68] shadow-sm">
              ...
              {task.assets.length === 0 ? (
                ...
                <div className="flex flex-wrap gap-2">
                  {task.assets.map((a) => {
                    ...
                    return (
                      <div key={a.id} className="w-[80px] overflow-hidden rounded-md border border-border/40 bg-background/60">
